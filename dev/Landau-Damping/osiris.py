...
#plt.figure(figsize=(12,8))
    ...
    plt.semilogy(taxis,landau_theory1,'r',label='Exact Root, Damping ='+repr(theory1))
    plt.semilogy(taxis,landau_theory2,'g',label='$df/dv$ estimate, Damping ='+repr(theory2))
