...
def newifile(iname='forslund-sbs.txt', oname='case1.txt',  
             a0=0.1, rtemp=10,  tmax=2500.0 ):
...
def sbs_widget():
    ...
    d = widgets.FloatText(value=10.0,description='te/ti:',style=style,layout=layout)
    e = widgets.FloatText(value=2500.0,description='tmax:',style=style,layout=layout)

    
    im = interact_calc(newifile, iname=a,oname=b,a0=c,rtemp=d,tmax=e); 
