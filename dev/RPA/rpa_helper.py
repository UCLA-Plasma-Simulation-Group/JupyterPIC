...
def newifile(iname='yan-circ.txt', oname='case1.txt',  
             a0=3.0, tmax=900.0 ):
...
def rpa_widget():
    ...
    a = widgets.Text(value='yan-circ.txt', description='Template Input File:',style=style,layout=layout)
    b = widgets.Text(value='case1.txt', description='New Output File:',style=style,layout=layout)
    c = widgets.FloatText(value=1.0,description='a0:',style=style,layout=layout)
    d = widgets.FloatText(value=900.0,description='tmax:',style=style,layout=layout)
    
    # print('d='+repr(d))
    im = interact_calc(newifile, iname=a,oname=b,a0=c, tmax=d);
